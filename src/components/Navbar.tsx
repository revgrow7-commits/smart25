...
import logo from "@/assets/logo-smartsignage-navbar.png";
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/blog" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
        ...
        {isMobileMenuOpen && <div className="md:hidden py-4 space-y-4 border-t border-border bg-background relative z-50">
            ...
            <Link to="/blog" className="flex items-center gap-2 text-sm font-medium text-foreground hover:text-primary transition-colors py-2 px-2" onClick={() => setIsMobileMenuOpen(false)}>
              <FileText className="w-4 h-4" />
              Blog
            </Link>
