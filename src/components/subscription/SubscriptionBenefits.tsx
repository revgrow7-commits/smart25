      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Benefícios <span className="bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Exclusivos</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit, index) => (
            <div 
              key={index}
              className="group relative p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-purple-500/20 hover:border-purple-400/40 transition-all duration-500 hover:shadow-[0_0_40px_rgba(147,51,234,0.15)]"
            >
              ...
              {/* Icon */}
              <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-purple-600/30 to-fuchsia-600/30 border border-purple-500/30 flex items-center justify-center mb-4 group-hover:shadow-[0_0_20px_rgba(147,51,234,0.3)] transition-all duration-300">
                <benefit.icon className="w-7 h-7 text-purple-300 group-hover:text-purple-200 transition-colors" />
              </div>
              
              {/* Content */}
              <h3 className="relative text-xl font-semibold text-white mb-2 group-hover:text-purple-100 transition-colors">
                {benefit.title}
              </h3>
              ...
              {/* Neon glow on hover */}
              <div className="absolute -inset-px rounded-2xl bg-gradient-to-r from-purple-500/0 via-purple-500/0 to-fuchsia-500/0 group-hover:from-purple-500/20 group-hover:via-purple-500/10 group-hover:to-fuchsia-500/20 transition-all duration-500 -z-10 blur-sm" />
            </div>
          ))}
        </div>
      </div>
