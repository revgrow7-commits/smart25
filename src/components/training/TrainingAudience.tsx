...
const TrainingAudience = () => {
  ...
  return (
    <section id="audience" className="py-16 md:py-24 relative bg-[#0d0520]/50">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {audiences.map((audience, index) => (
              <div
                key={index}
                className="flex items-center gap-4 p-5 rounded-xl bg-gradient-to-br from-purple-900/30 to-pink-900/20 border border-purple-500/20 hover:border-purple-500/40 hover:shadow-[0_0_20px_rgba(139,92,246,0.2)] transition-all duration-300"
              >
