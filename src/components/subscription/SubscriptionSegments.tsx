...
const SubscriptionSegments = () => {
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-[#0a0015] to-[#0d001a] relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-1/4 right-0 w-80 h-80 bg-purple-600/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 left-0 w-80 h-80 bg-fuchsia-600/10 rounded-full blur-[120px]" />
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Para quem é o <span className="bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Smart Club</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {segments.map((segment, index) => (
            <div 
              key={index}
              className="group relative p-6 rounded-2xl bg-gradient-to-br from-purple-900/20 to-fuchsia-900/20 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-500 hover:shadow-[0_0_30px_rgba(147,51,234,0.2)] text-center"
            >
              ...
              {/* Icon */}
              <div className="relative w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-purple-600/40 to-fuchsia-600/40 border border-purple-500/30 flex items-center justify-center mb-4 group-hover:shadow-[0_0_25px_rgba(147,51,234,0.4)] transition-all duration-300">
                <segment.icon className="w-8 h-8 text-purple-300 group-hover:text-purple-200 transition-colors" />
              </div>
              
              {/* Content */}
              <h3 className="relative text-lg font-semibold text-white mb-2 group-hover:text-purple-100 transition-colors">
                {segment.title}
              </h3>
