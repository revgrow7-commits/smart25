          ...
          <Card className="p-6 md:p-8 space-y-6 md:space-y-8 bg-card border-border">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 md:gap-4">
                <span className="text-muted-foreground text-sm md:text-base">R$</span>
                <Input
                  type="number"
                  value={traditionalCost}
                  onChange={(e) => setTraditionalCost(Number(e.target.value))}
                  className="flex-1 bg-background border-border text-base md:text-lg"
                />
              </div>
              <Slider
                value={[traditionalCost]}
            ...
            <div className="space-y-4">
              <label className="text-base md:text-lg font-semibold">Eventos por ano</label>
              <Slider
                value={[eventsPerYear]}
              ...
              <div className="flex justify-center">
                <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-primary to-secondary text-2xl md:text-3xl font-bold">
                  {eventsPerYear}
                </div>
              </div>
            ...
            <div className="pt-4 md:pt-6 space-y-2 text-xs md:text-sm text-muted-foreground border-t border-border">
          ...
          <div className="space-y-4 md:space-y-6">
            <Card className="p-6 md:p-8 bg-gradient-to-br from-primary/20 to-secondary/20 border-primary/30 hover-lift">
              <div className="text-center">
                <h3 className="text-base md:text-lg lg:text-xl font-semibold mb-2">Sua Economia em 3 Anos</h3>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 lg:gap-6">
              <Card className="p-4 md:p-6 bg-card border-border hover-lift">
                ...
                <div className="text-xl sm:text-2xl md:text-3xl font-bold gradient-text">{paybackMonths} meses</div>
            ...
            <Card className="p-5 md:p-6 bg-card border-border">
              <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
                ...
                <span className="text-sm md:text-base font-semibold">Economia Total</span>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-xl md:text-2xl font-bold text-green-500">-{savingsPercentage}%</span>
                <span className="text-xs md:text-sm text-muted-foreground">vs tradicional</span>
              </div>
            </Card>
          </div>
        </div>
